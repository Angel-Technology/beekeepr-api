        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlaggedUserId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserFlags_Users_FlaggedUserId",
                        column: x => x.FlaggedUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserFlags_Users_FlaggerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFlags_FlaggedUserId",
                table: "UserFlags",
                column: "FlaggedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserFlags_FlaggerId_FlaggedUserId",
                table: "UserFlags",
                columns: new[] { "FlaggerId", "FlaggedUserId" },
                unique: true);
        }
